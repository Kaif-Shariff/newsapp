...
class AppTheme {
  static final lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      headlineSmall: TextStyle(fontSize: 9, color: AppColors.lightTextColor),
      headlineMedium: TextStyle(fontSize: 15, color: AppColors.lightTextColor),
      headlineLarge: TextStyle(fontSize: 25, color: AppColors.lightTextColor),
      bodySmall: TextStyle(fontSize: 9, color: AppColors.lightTextColor),
      bodyMedium: TextStyle(fontSize: 15, color: AppColors.lightTextColor),
      bodyLarge: TextStyle(fontSize: 25, color: AppColors.lightTextColor),
    ),
